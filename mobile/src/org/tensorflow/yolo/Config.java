...
public interface Config {
    ...
    String MODEL_FILE = "crack-tiny-yolo.pb";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "crack-tiny-yolo-labels.txt"; // The filepath of label file for classes.
